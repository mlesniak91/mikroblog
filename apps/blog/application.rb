...
module Blog
  class Application < Lotus::Application
    configure do
      ...
      #
      layout :application # It will load Blog::Views::ApplicationLayout
      ...
      # It determines if a blog page can or cannot be included via <frame> and
      # <iframe> tags by untrusted domains.
      #
      # Blog applications can send this header to prevent Clickjacking attacks.
      #
      # Read more at:
      #
      #   * https://developer.mozilla.org/en-US/docs/Blog/HTTP/X-Frame-Options
      ...
      # (JavaScript) or other blog related assets: stylesheets, images, fonts,
      # plugins, etc.
      #
      # Blog applications can send this header to mitigate Cross Site Scripting
      # (XSS) attacks.
      #
      ...
      #  * https://developer.mozilla.org/en-US/docs/Blog/Security/CSP/Using_Content_Security_Policy
      #
      ...
      # Configure the code that will yield each time Blog::Action is included
      ...
      # Configure the code that will yield each time Blog::View is included
      # This is useful for sharing common functionality
      #
